 ...
 * ShopGsCodes
 *
 * @ORM\Table(name="SHOP_GS_Codes", indexes={@ORM\Index(name="gs_n_fid", columns={"gs_n_fid"}), @ORM\Index(name="gs_n_fid_2", columns={"gs_n_fid"})})
 * @ORM\Entity
 */
class ShopGsCodes
{
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="gs_n_gueltig_bis", type="datetime", nullable=false)
     */
