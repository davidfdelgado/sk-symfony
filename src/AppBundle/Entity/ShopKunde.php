...
class ShopKunde
{
     ...
     * @var string
     *
     * @ORM\Column(name="k_nachname", type="string", length=64, nullable=true)
     */
    private $kNachname;
     ...
     * @var string
     *
     * @ORM\Column(name="k_email", type="string", length=64, nullable=true)
     */
    private $kEmail;
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="k_edatum", type="datetime", nullable=false)
     */
    private $kEdatum = '0000-00-00 00:00:00';

    /**
     * @var integer
     *
     * @ORM\Column(name="k_newsletter", type="integer", nullable=true)
     */
    private $kNewsletter = '0';
