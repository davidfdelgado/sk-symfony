...
class ShopPosition
{
     ...
     * @var string
     *
     * @ORM\Column(name="p_tid", type="string", length=16, nullable=false)
     */
    private $pTid;
     ...
     * @var string
     *
     * @ORM\Column(name="p_adatum", type="string", length=10, nullable=false)
     */
    private $pAdatum;
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="p_checkin", type="datetime", nullable=false)
     */
    private $pCheckin;
     ...
     * Set pAdatum
     *
     * @param string $pAdatum
     *
     * @return ShopPosition
     */
    public function setPAdatum($pAdatum)
    {
