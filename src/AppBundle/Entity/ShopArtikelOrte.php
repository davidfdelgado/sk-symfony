 ...
 * ShopArtikelOrte
 *
 * @ORM\Table(name="SHOP_Artikel_Orte", uniqueConstraints={@ORM\UniqueConstraint(name="a_o_name_kurz", columns={"a_o_name_kurz"})})
 * @ORM\Entity
 */
class ShopArtikelOrte
{
    /**
     * @var string
     *
